...
const USER_WORKSPACE_NAME = 'angular';
const NODE_MODULES_ROOT = 'build_bazel_rules_nodejs/node_modules';
const BIN_DIR = 'bazel-out/x64_windows-fastbuild/bin';
const GEN_DIR = 'bazel-out/x64_windows-fastbuild/bin';
const TARGET = '//packages/common/locales:closure_locale_file.update';
