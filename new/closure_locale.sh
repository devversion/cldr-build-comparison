...
export BAZEL_TARGET=//packages/common/locales:closure_locale
...
export BAZEL_NODE_PATCH_REQUIRE=$(rlocation "angular/packages/common/locales/closure_locale_require_patch.js")
# Paths can be with lower and upper case on windows because of the msys64 package in the powershell
# https://regex101.com/r/c0Gjn8/1/
...
if [ "$RUN_LINKER" = true ]; then
  ...
  MODULES_MANIFEST=${MODULES_MANIFEST:-$(rlocation "angular/packages/common/locales/_closure_locale.module_mappings.json")}
...
if [ "$PATCH_REQUIRE" = true ]; then
  ...
  MAIN=$(rlocation "angular/packages/common/locales/closure_locale_loader.js")
else
