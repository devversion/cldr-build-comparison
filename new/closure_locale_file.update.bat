...
call :rlocation "angular/packages/common/locales/closure_locale_file.update.sh" run_script
for %%a in ("C:/Program Files/Git/usr/bin/bash.exe") do set "bash_bin_dir=%%~dpa"
...
"C:/Program Files/Git/usr/bin/bash.exe" -c "!run_script! !args!"
