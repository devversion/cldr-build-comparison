...
export BAZEL_TARGET=//packages/common/locales:closure_locale_file
...
export BAZEL_NODE_PATCH_REQUIRE=$(rlocation "angular/packages/common/locales/closure_locale_file_require_patch.js")
# Paths can be with lower and upper case on windows because of the msys64 package in the powershell
# https://regex101.com/r/c0Gjn8/1/
...
USER_NODE_OPTIONS=()
ALL_ARGS=(--verify packages/common/locales/closure-locale.ts packages/common/locales/closure-locale.ts packages/common/locales/closure_locales_generated.ts "$@")
STDOUT_CAPTURE=""
STDERR_CAPTURE=""
EXIT_CODE_CAPTURE=""
NODE_WORKING_DIR=""
...
if [ "$RUN_LINKER" = true ]; then
  ...
  MODULES_MANIFEST=${MODULES_MANIFEST:-$(rlocation "angular/packages/common/locales/_closure_locale_file.module_mappings.json")}
...
if [ "$PATCH_REQUIRE" = true ]; then
  ...
  MAIN=$(rlocation "angular/packages/common/locales/closure_locale_file_loader.js")
else
